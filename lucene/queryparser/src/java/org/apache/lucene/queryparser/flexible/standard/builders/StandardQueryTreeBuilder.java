...
/**
 * This query tree builder only defines the necessary map to build a {@link Query} tree object. It
 * should be used to generate a {@link Query} tree object from a query node tree processed by a
